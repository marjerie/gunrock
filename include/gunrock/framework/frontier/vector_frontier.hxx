...
class vector_frontier_t {
 public:
   ...
   */
  vector_frontier_t()
      : num_elements(0), raw_ptr(nullptr), resizing_factor(1.75f) {
   ...
   */
  vector_frontier_t(std::size_t size, float frontier_resizing_factor = 1.75f)
...
//     /// TODO: we are using a vector of size 1 to avoid the overhead of setting
//     /// it up later. Check if this is valid to do.
//     thrust::device_vector<type_t, thrust::virtual_allocator<type_t>> new_p_storage;
//     p_storage = new_p_storage;
//   }
...
// #else
//     p_storage = rhs.p_storage;
//     raw_ptr = (int *) rhs.p_storage.data().get();
// #endif
//     num_elements = rhs.num_elements;
//     resizing_factor = rhs.resizing_factor;
//   }
...
//    * @return std::size_t
//    */
//   std::size_t get_capacity() const { return p_storage.capacity(); }
...
//   auto data() { return raw_pointer_cast(p_storage.data()); }
//   auto begin() { return this->data(); }
//   auto end() { return this->begin() + this->get_number_of_elements(); }
//   bool is_empty() const { return (this->get_number_of_elements() == 0); }
...
//    */
//   void reserve(std::size_t const& size) {
//     p_storage.reserve(size * resizing_factor);
//   }
...
//  private:
//   thrust::device_vector<type_t, thrust::virtual_allocator<type_t>> p_storage;
//   type_t* raw_ptr;
//   std::size_t num_elements;  // number of elements in the frontier.
//   float resizing_factor;     // reserve size * factor.
// };
